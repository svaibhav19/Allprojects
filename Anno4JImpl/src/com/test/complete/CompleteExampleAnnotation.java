...
/**
 * 
 * @author Vaibhav Sakharkar This program is the complete Implementations of
 *         https://www.w3.org/TR/annotation-model/#complete-example W3C web Site
 *         to show the demo of its implementations and functionality and to
 *         check what all things are possible using anno4j.
 *
 */
public class CompleteExampleAnnotation {

	private Anno4j anno4j;
	private Annotation annotation;

	public void initliseObj()
	...
	public void startBuildingExample() throws RepositoryException, IllegalAccessException, InstantiationException {
